...
<div class="row mb-2">
    <div @class(['col-md-6', 'text-bg-danger'=> $hasError , 'text-bg-info' => !$hasError ])>

        <input type="text">
        @foreach ($users as $user )

        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            <div class="col p-4 d-flex flex-column position-static" style="background-color: darkgoldenrod">
                <strong class="d-inline-block mb-2 text-primary-emphasis">{{ $user['name'] }}</strong>
                <h3 class="mb-0">Featured post</h3>
                <div class="mb-1 text-body-secondary">{{ $user['id'] }}</div>
                <p class="card-text mb-auto">index :: {{ $loop->parent }}</p>
